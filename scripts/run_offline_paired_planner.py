...
def main() -> None:
    ...
    cem, rollout_config, seed, horizon_s = load_cem_planner_config(args.cem_config)
    ...
    summary = {
        ...
        "query": {
            ...
            "previous_previous_action_local_cm_s": list(query.previous_previous_action_local_cm_s),
