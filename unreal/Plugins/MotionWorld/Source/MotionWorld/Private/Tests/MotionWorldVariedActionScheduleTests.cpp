...
bool FMotionWorldVariedActionScheduleTest::RunTest(const FString& Parameters)
{
	...
	const FCase Cases[] = {
		...
		{Motion + Stop, EMotionWorldVariedActionPhase::Reverse, FVector(-150.0, 0.0, 0.0), -FVector::ForwardVector, false},
		{2.0 * Motion + Stop, EMotionWorldVariedActionPhase::ReverseStop, FVector::ZeroVector, -FVector::ForwardVector, false},
